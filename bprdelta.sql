...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2021 at 02:16 PM
...
(19, '2020_05_15_101819_alter_gambar_dokumens_table', 2),
(20, '2021_05_01_065603_create_depositos_table', 2),
(21, '2021_05_01_070424_create_tabungans_table', 2),
(22, '2021_05_01_074810_create_kredits_table', 2),
(23, '2021_05_01_074941_create_typetabungans', 2),
(24, '2021_05_01_075036_create_typekredits_table', 2),
(25, '2021_05_01_120107_create_homes_table', 2),
(26, '2021_05_02_002725_create_tentangs_table', 2);
...
(1, 'Kredit Modal Kerja', '<p>Morbi ut dapibus dui. Sed ut iaculis elit, quis varius mauris. Integer ut ultricies orci, lobortis egestas sem. Morbi ut dapibus dui. Sed ut iaculis elit. Integer ut imperdiet erat. Quisque ultricies lectus tellus, eu tristique magna pharetra nec. Fusce vel lorem libero. Integer ex mi, facilisis sed nisi ut, vestibulum ultrices nulla. Aliquam egestas tempor leo yee</p>', '1typekredit.jpg', 1, NULL, NULL),
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `updatepengaduan` ON SCHEDULE EVERY 1 DAY STARTS '2021-05-24 23:46:50' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE pengaduan
  SET selesai_pengadu = 1
  WHERE tgl_selesai_pengadu = NOW()$$
