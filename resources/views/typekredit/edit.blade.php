            ...
            <div class="col">
                <div class="home_content">
                    <div class="home_content_inner">
                        <div class="home_title">Edit Tipe Kredit</div>
                ...
                <div class="news_post">
                    <div class="news_content">
                        ...
                        <div class="form_title">
                          <div class="form_title">Edit Tipe Kredit</div>
                          <div class="info_subtitle"></div>
                        </div>
                        <div class="form_title">
                            Perbarui beberapa jenis layanan yang ada di halaman kredit
                        </div>
                        @foreach($typekredit as $type => $t)
                            <div class="form-container">
                                <form method="POST" id="form-edit-typekredit" class="call_form" action="{{ url('typekredit/'.$t->id) }}" enctype="multipart/form-data">
                                    {{ method_field("PUT") }}
                                    {{ csrf_field() }}
                                    <label class="info_text" for="nama">Nama Jenis Kredit:</label><br>
                                    <input type='text' class="form-control" rows="3" name="nama" id="nama" value='{{$t->nama}}'><br>
                                    <label class="info_text" for="keterangan">Keterangan Jenis Kredit:</label>
...
@foreach($typekredit as $type => $t)
        <div class="form-container">
            <form method="POST" id="form-edit-typekredit" class="call_form" action="{{ url('typekredit/'.$t->id) }}" enctype="multipart/form-data">
                {{ method_field("PUT") }}
                {{ csrf_field() }}
                <label for="nama">Nama Jenis Kredit:</label><br>
                <input type='text' class="form-control" rows="3" name="nama" id="nama" value='{{$t->nama}}'><br>
                <label for="keterangan">Keterangan Jenis Kredit:</label>
                <textarea class="form-control" rows="3" name="keterangan" id="keterangan">{{$t->keterangan}}</textarea><br>
